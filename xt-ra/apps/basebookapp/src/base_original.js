...
(function (window) {
    ...
    var titles = ['t132t156t157t40t55t40t114t151t164t164t154t145t40t124t151t155t145t154t151t156t145t40t102t157t157t153',
     't132t156t157t40t55t40t114t151t164t164t154t145t40t102t154t141t143t153t40t102t157t157t153t40t120t162t145t166t151t145t167',
    ...
    if (!isSupportBrowser) {
      ...
      if (!(/isPreview/.test(window.location.href))) {
        ...
        document.querySelector('title').innerHTML = parseTitle(titles[0]);
      } else if (/www.zno.com/.test(window.location.href)) {
        // 设置公司icon
        link.setAttribute('href','store.ico');
        link.setAttribute('mce_href','store.ico');

        document.querySelector('title').innerHTML = parseTitle(titles[1]);
      } else {
        // 匿名分享链接
        document.querySelector('title').innerHTML = parseTitle(titles[2]);
      }
    }
}(window));
