	...
	var OrientationSelector = function (_Component) {
	  ...
	  (0, _createClass3.default)(OrientationSelector, [{
	    ...
	    value: function render() {
	      ...
	      var changeOrientation = orientation === 'Landscape' ? 'Portrait' : 'Landscape';
	      return _react2.default.createElement(
	        'div',
	        { className: 'bottons-wrap' },
	        _react2.default.createElement('img', { src: _rotate2.default, className: 'rotate_button', onClick: function onClick() {
	            _this2.rotatePage(changeOrientation);
	          } })
	      );
	    }
	  }]);
...
//# sourceMappingURL=0.0d9279c5dd5ee35f91cf.hot-update.js.map