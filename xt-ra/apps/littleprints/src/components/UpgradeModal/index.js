...
class UpgradeModalV2 extends Component {
  ...
  render() {
    const { isShown, close, boundProjectActions, data } = this.props;
    const {
      urls,
      size,
      ratios,
    ...
    const rightStyle = isChecked ? { marginTop: '10px' } : { marginTop: '34px' };
    ...
    return (
      <XModal
        ...
        opened={isShown}
      >
        <div className="upgrade-title">Would you like to upgrade your Little Prints Stand?</div>
        <div className="upgrade-content">
          <div className="upgrade-bottom-position">
            <div className="upgrade-container upgrade-left">
              <div className="upgrade-item-fit">
                <Screenshot
            ...
            <div className="upgrade-container upgrade-right" style={rightStyle}>
              <div className="upgrade-item-fit">
        ...
        <div className="upgrade-checked-items">
          <XCheckBox
            ...
            contents={'8x6 is significantly bigger and looks more impressive'}
            isShowChecked
