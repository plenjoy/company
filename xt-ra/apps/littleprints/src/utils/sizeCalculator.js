...
export const getBgParams = (baseSize, variables) => {
  ...
  const innerForegroundContentWidthLandscape = innerForeground.get('hwidth') - innerForeground.get('hbottomPageLeft') - innerForeground.get('hbottomPageRight');
  const innerForegroundContentHeightLandscape = innerForeground.get('hheight') - innerForeground.get('hbottomPageTop') - innerForeground.get('hbottomPageBottom');
  const innerForegroundRatioXLandscape = innerForegroundContentWidthLandscape / baseHeight;
  const innerForegroundRatioYLandscape = innerForegroundContentHeightLandscape / baseWidth;
  const innerBgParamsLandscape = {
    width: innerForeground.get('hwidth') / innerForegroundRatioXLandscape,
    height: innerForeground.get('hheight') / innerForegroundRatioYLandscape,
    topPageLeft: innerForeground.get('htopPageLeft') / innerForegroundRatioXLandscape,
    topPageTop: innerForeground.get('htopPageTop') / innerForegroundRatioYLandscape,
    bottomPageLeft: innerForeground.get('hbottomPageLeft') / innerForegroundRatioXLandscape,
    bottomPageTop: innerForeground.get('hbottomPageTop') / innerForegroundRatioYLandscape
  };
  ...
  const allPageInnerForegroundContentWidthLandscape = allPageInnerForeground.get('hwidth') - allPageInnerForeground.get('hbottomPageLeft') - allPageInnerForeground.get('hbottomPageRight');
  const allPageInnerForegroundContentHeightLandscape = allPageInnerForeground.get('hheight') - allPageInnerForeground.get('hbottomPageTop') - allPageInnerForeground.get('hbottomPageBottom');
  const allPageInnerForegroundRatioXLandscape = allPageInnerForegroundContentWidthLandscape / baseHeight;
  const allPageInnerForegroundRatioYLandscape = allPageInnerForegroundContentHeightLandscape / baseWidth;
  const allPageInnerBgParamsLandscape = {
    width: allPageInnerForeground.get('hwidth') / allPageInnerForegroundRatioXLandscape,
    height: allPageInnerForeground.get('hheight') / allPageInnerForegroundRatioYLandscape,
    topPageLeft: allPageInnerForeground.get('htopPageLeft') / allPageInnerForegroundRatioXLandscape,
    topPageTop: allPageInnerForeground.get('htopPageTop') / allPageInnerForegroundRatioYLandscape,
    bottomPageLeft: allPageInnerForeground.get('hbottomPageLeft') / allPageInnerForegroundRatioXLandscape,
    bottomPageTop: allPageInnerForeground.get('hbottomPageTop') / allPageInnerForegroundRatioYLandscape
  };
  return {
    coverBgParams,
    innerBgParams,
    innerBgParamsLandscape,
    allPageCoverBgParams,
    allPageInnerBgParams,
    allPageInnerBgParamsLandscape
  };
};
...
export const getRenderSize = (project, ratios, parameters, variables, isPreview = false) => {
  ...
  const { coverBgParams, innerBgParams, innerBgParamsLandscape } = calendarBgParams;
  ...
  const renderInnerSizeLandscape = !ratios.innerWorkspaceLandscape ? innerBgParamsLandscape : {
    width: Math.ceil(innerBgParamsLandscape.width * ratios.innerWorkspaceLandscape),
    height: Math.ceil(innerBgParamsLandscape.height * ratios.innerWorkspaceLandscape)
  };
  ...
  const renderInnerContainerSizeLandscape = !ratios.innerWorkspaceLandscape ? innerBgParamsLandscape : {
    width: Math.ceil(innerBgParamsLandscape.width * ratios.innerWorkspaceLandscape),
    height: Math.ceil(innerBgParamsLandscape.height * heightShowRatio * ratios.innerWorkspaceLandscape)
  };
  ...
  const calendarBgParamsLandscape = merge({}, calendarBgParams, { innerBgParams: innerBgParamsLandscape });
  const renderInnerSheetSizeLandscape = getRenderSheetSize(baseSize, parameters, ratios.innerWorkspaceLandscape, calendarBgParamsLandscape, false, false);

  const obj = {
    renderCoverSize,
    renderInnerSize,
    renderInnerSizeLandscape,
    renderInnerContainerSize,
    renderInnerContainerSizeLandscape,
    ...
    renderInnerSheetSizeLandscape: merge({}, renderInnerSheetSizeLandscape.container, {
      width: get(renderInnerSheetSizeLandscape, 'container.height'),
      height: get(renderInnerSheetSizeLandscape, 'container.width')
    }),
    renderInnerSheetSizeWithoutBleedLandscape: merge({}, renderInnerSheetSizeLandscape.sheet, {
      width: get(renderInnerSheetSizeLandscape, 'sheet.height'),
      height: get(renderInnerSheetSizeLandscape, 'sheet.width')
    })
  };
...
export const computedSizeForSpecialView = (project, size, ratios, parameters, variables) => {
  ...
  const { allPageInnerBgParams, allPageCoverBgParams, allPageInnerBgParamsLandscape } = calendarBgParams;
  ...
  const renderInnerSizeLandscape = !ratios.innerWorkspaceForArrangePages ? allPageInnerBgParamsLandscape : {
    width: Math.ceil(allPageInnerBgParamsLandscape.width * ratios.innerWorkspaceForArrangePages),
    height: Math.ceil(allPageInnerBgParamsLandscape.height * ratios.innerWorkspaceForArrangePages)
  };
  ...
  const renderInnerContainerSizeLandscape = !ratios.innerWorkspaceForArrangePages ? allPageInnerBgParamsLandscape : {
    width: Math.ceil(allPageInnerBgParamsLandscape.width * ratios.innerWorkspaceForArrangePages),
    height: Math.ceil(allPageInnerBgParamsLandscape.height * heightShowRatio * ratios.innerWorkspaceForArrangePages)
  };
  ...
  const calendarBgParamsLandscape = merge({}, calendarBgParams, { allPageInnerBgParams: allPageInnerBgParamsLandscape });
  const renderInnerSheetSizeLandscape = getRenderSheetSize(baseSize, parameters, ratios.innerWorkspaceForArrangePages, calendarBgParamsLandscape, false, true);
...
export const computedSizeForUpgrade = (project, size, ratios, parameters, variables) => {
  ...
  const renderInnerSizeLandscape = !ratios.innerWorkspaceForUpgradeLandscape ? innerBgParamsLandscape : {
    width: Math.ceil(innerBgParamsLandscape.width * ratios.innerWorkspaceForUpgradeLandscape),
    height: Math.ceil(innerBgParamsLandscape.height * ratios.innerWorkspaceForUpgradeLandscape)
  };
  ...
  const renderInnerContainerSizeLandscape = !ratios.innerWorkspaceForUpgradeLandscape ? innerBgParamsLandscape : {
    width: Math.ceil(innerBgParamsLandscape.width * ratios.innerWorkspaceForUpgradeLandscape),
    height: Math.ceil(innerBgParamsLandscape.height * heightShowRatio * ratios.innerWorkspaceForUpgradeLandscape)
  };
  ...
  const calendarBgParamsLandscape = merge({}, calendarBgParams, { innerBgParams: innerBgParamsLandscape });
  const renderInnerSheetSizeLandscape = getRenderSheetSize(baseSize, parameters, ratios.innerWorkspaceForUpgradeLandscape, calendarBgParamsLandscape);
