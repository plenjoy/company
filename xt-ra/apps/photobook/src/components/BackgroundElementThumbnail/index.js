...
class BackgroundElementThumbnail extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const elementData = merge({}, data, {
      className: classNames('bakground-element', {
        'has-image': !!imgUrl,
...
export default translate('DecorationElement')(BackgroundElementThumbnail);
