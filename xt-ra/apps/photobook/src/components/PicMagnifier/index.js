...
class PicMagnifier extends Component {
  ...
  render() {
    ...
    const { isMagnifierShow, offset, name, pixel, width, height, orientation = 0 } = data;
    ...
    return (
      <div className="PicMagnifier" style={style}>
        ...
        {
          imageUrl ? <img src={imageUrl} className="fill" style={imgStyle} /> : null
        }
        ...
        <div className="arrow-filter" style={arrowStyle} />
      </div>
    );
  }
}
