...
import { shapeType, ignoreShapes, elementTypes } from '../../contants/strings';
 ...
 * @param  {Number} fontSize 默认值为12
 */
export const getBackgroundElementOptions = (
  that,
  text,
...
export const setSpineMaxDep = elementArray => {
  ...
  if (spineTextelemet) {
    ...
    newElementArray = elementArray.setIn([String(index), 'dep'], maxDep + 1000);
