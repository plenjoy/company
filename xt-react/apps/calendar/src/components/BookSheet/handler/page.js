...
import { elementTypes, pageTypes, dragPageSelector } from '../../../constants/strings';
...
export const computedInnerSheet = (
  ...
  let renderInnerSheetSize = {
    ...
    top: size.renderInnerSheetSize.top,
    left: size.renderInnerSheetSize.left
  };
  ...
  // 判断当前的page是不是page,
  if (page.get('type') === pageTypes.top) {
    renderInnerSheetSizeWithoutBleed.top = size.renderInnerSheetSizeWithoutBleed.topPageTop;
    renderInnerSheetSizeWithoutBleed.left = size.renderInnerSheetSizeWithoutBleed.topPageLeft;
  } else if (page.get('type') === pageTypes.bottom) {
    renderInnerSheetSizeWithoutBleed.top = size.renderInnerSheetSizeWithoutBleed.bottomPageTop;
    renderInnerSheetSizeWithoutBleed.left = size.renderInnerSheetSizeWithoutBleed.bottomPageLeft;
  }
