...
class XTitleEditor extends Component {
  constructor(props) {
    super(props);
            ...
            boundNotificationActions.addNotification({
              children: (
                <div>
                  ...
                  Clicking <a onClick={openLoginPage}>log in</a> will open a new
                  window. Once successfully log in, you may return to this
  ...
  render() {
    ...
    const canEditTitle = capability ? capability.get('canEditTitle') : true;
...
XTitleEditor.propTypes = {};

export default XTitleEditor;
