...
export const ratioTypes = {
  ...
  innerWorkspaceLandscape: 'innerWorkspaceLandscape',
  ...
  previewInnerWorkspaceLandscape: 'previewInnerWorkspaceLandscape',

  // upgrade model
  coverWorkspaceForUpgrade: 'coverWorkspaceForUpgrade',
  innerWorkspaceForUpgrade: 'innerWorkspaceForUpgrade',
  innerWorkspaceForUpgradeLandscape: 'innerWorkspaceForUpgradeLandscape'
};
...
export const limitedPageNum = 12;
