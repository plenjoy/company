...
class BookSettingsModal extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      professionalView: bookSetting.get('professionalView'),
    ...
    this.onSliderBorderOpacityChange = this.onSliderBorderOpacityChange.bind(
      this
    );
    ...
    this.onBorderOpacityInputChange = this.onBorderOpacityInputChange.bind(
      this
    );
    this.onBorderOpacityInputBlur = this.onBorderOpacityInputBlur.bind(this);

    // checkbox.
    this.onChangeBackgroundCheckbox = this.onChangeBackgroundCheckbox.bind(
      this
    );
    this.onChangeFontCheckbox = this.onChangeFontCheckbox.bind(this);
    this.onChangeBorderFrameCheckbox = this.onChangeBorderFrameCheckbox.bind(
      this
    );

    // professional view
    this.onChangeProfessionalView = this.onChangeProfessionalView.bind(
      this
    );
  }
  ...
  onChangeProfessionalView() {
    this.setState({
      professionalView: !this.state.professionalView
    });
  }
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (
      ...
      this.state.professionalView !== nextState.professionalView
    ) {
      return true;
    }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className="setting-panel">
          <h4 className="panel-title">
            <span>{t('DEFAULT_VIEW')}</span>
          </h4>
          <div className="setting-box">
            <div className="setting-item clearfix">
              <span className="left professional-view">{t('PROFESSIONAL_VIEW')}:</span>
              <XToggleSwitch
                className="left"
                checked={professionalView}
                onChange={this.onChangeProfessionalView}
              />
            </div>
          </div>
        </div>
        ...
        <p className="button-container">
          ...
          <XButton width={160} onClicked={this.onSubmit}>
            {t('DONE')}
          </XButton>
        </p>
      </XModal>
