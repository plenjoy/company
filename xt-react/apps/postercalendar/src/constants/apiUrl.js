...
export const GET_RELATION_TEMPLATE =
  '<%=baseUrl%>template/global/getRelationTemplate.ep?templateGUID=<%=templateGUID%>&size=<%=size%>&coverType=CL&autoRandomNum=<%=autoRandomNum%>';
...
export const TEMPLATE_SRC =
  '<%=templateThumbnailPrefx%>TemplateThumbnail/<%=size%>/<%=guid%>.jpg?size=<%=size%>&randomMumber=20170918';
