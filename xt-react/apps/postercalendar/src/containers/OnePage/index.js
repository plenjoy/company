...
class OnePage extends Component {
  constructor(props) {
    ...
    this.applyRelativeTemplate = options => layoutHandler.applyRelativeTemplate(this, options);
  ...
  render() {
    ...
    return (
      <div className={className}>
        <div className="available-client" style={availableClient}>
