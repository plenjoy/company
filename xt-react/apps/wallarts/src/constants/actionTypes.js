...
export const UPDATE_FRAME_MATERIAL = 'UPDATE_FRAME_MATERIAL';
export const UPDATE_MATTE_MATERIAL = 'UPDATE_MATTE_MATERIAL';
export const SET_ORIGINAL_MATERIALS = 'SET_ORIGINAL_MATERIALS';
export const UPDATE_PREVIEW_FRAME_MATERIAL = 'UPDATE_PREVIEW_FRAME_MATERIAL';
export const DOWNLOAD_MATERIALS_STATUS = 'DOWNLOAD_MATERIALS_STATUS';

export const CHANGE_CANVAS_BORDER_COLOR = 'CHANGE_CANVAS_BORDER_COLOR';

export const UPDATE_SNIPPING_IMAGES = 'UPDATE_SNIPPING_IMAGES';
