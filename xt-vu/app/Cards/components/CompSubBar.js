  ...
  computed: {
    ...
    left: function() {
      ...
      if(((parentEl.x)*currentCanvas.ratio)>this.sharedStore.barPosition.x){
        ...
        if(this.sharedStore.barPosition.x < 130){
          return (-this.sharedStore.barPosition.x + 24 * currentCanvas.ratio) + 'px';
        }else{
          return "-130px";
        };
      }else{
    ...
    bottom:function() {
      ...
      }else if(parentEl.elType=="decoration" && (currentCanvas.height-166)<this.sharedStore.barPosition.y){
        if((currentCanvas.height-88)<this.sharedStore.barPosition.y){
          return 0
        }else{
          return -(currentCanvas.height - this.sharedStore.barPosition.y - 78)+"px";
        }
