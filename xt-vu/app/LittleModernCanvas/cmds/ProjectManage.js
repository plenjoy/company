...
module.exports = {
  ...
  initPage: function() {
    var baseSize = require('JsonProjectManage').getLMCBaseSize();
    var bleedSize = require('JsonProjectManage').getLMCBleedSize();
    var canvasBorder = require('JsonProjectManage').getLMCCanvasBorder();
  ...
  getPages: function() {
    ...
    for(var i = 0; i < Store.pages.length; i++ ) {
      ...
      var bleedSize = require('JsonProjectManage').getLMCBleedSize(i);
      var photoLayer = require('JsonProjectManage').getLMCPhotoLayer(i);
      var canvasBorder = require('JsonProjectManage').getLMCCanvasBorder(i);
