...
module.exports = {
  ...
  methods: {
     handleRemoveImage: function() {
      ...
      require('trackerService')({ev: require('trackerConfig').ClickRemoveImage,orientation:currentProject.orientation});
    ...
    handleRotate: function(nDegree) {
      ...
      var currentProject = Store.projectSettings[Store.currentSelectProjectIndex];
      require('trackerService')({ev: require('trackerConfig').ClickRotateImage,orientation:currentProject.orientation});
    },
