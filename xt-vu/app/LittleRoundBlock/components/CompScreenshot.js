...
module.exports = {
  ...
  methods: {
      createScreenshot : function(pageIdx){
          ...
          this.$dispatch("notifyRefreshRealScreenshot",pageIdx,currentCanvas.ratio);
      },
      createRealScreenShot : function(pageIdx){
          ...
          if(Store.projectSettings[pageIdx].size in Store.upgradeSizeMaps) {
            this.$dispatch('dispatchChangeUpgradeSize', Store.projectSettings[pageIdx].size);
            Store.vm.$broadcast('notifyDrawUpgradWindow');
          }
      },
  ...
  events: {
      ...
      notifyRefreshRealScreenshot : function(pageIdx,ratio){
        ...
        Store.beforeUpgradeScreenshot = require('ScreenshotController').convertScreenshotToBase64();
      },
