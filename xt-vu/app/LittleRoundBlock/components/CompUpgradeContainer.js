                ...
                '<div v-bind:style="flipperStyle">'+
                    '<div id="upgradePageView" v-bind:style="frontPageStyle" >' +
                      '<div style="position: relative;width: 100%; height: 100%; overflow: hidden;">' +
                        ...
                        '</div>' +
                      '</div>' +
                      '<upgrade-bg-layer v-show="!sharedStore.isCanvas" v-bind:idx="idx" v-bind:ratio="privateStore.ratio" v-bind:main="main" v-bind:width="Math.floor(privateStore.operationWidth)" v-bind:height="Math.floor(privateStore.operationHeight)" v-bind:draw-count="privateStore.drawCount"></upgrade-bg-layer>' +
