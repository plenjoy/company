  ...
  methods: {
      createMirror : function(){
          ...
          if(this.sharedStore.isMirrorBorder){
              ...
              //right
              imageData = DrawManage.getImageData("screenshot",w - 2 * mLength,mLength,mLength,Math.floor(h-mLength/2));
              newData = DrawManage.createImageData("mirror-right",mLength,Math.floor(h-mLength/2));
              DrawManage.fillImageData("mirror-right",imageData,0,mLength,mLength,Math.floor(h-mLength/2));
