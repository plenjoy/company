...
// component -- list tab
module.exports = {
	template: '<div class="bed-list-tab" v-on:click="blurFocus" style="border-right: 1px solid rgba(232, 232, 232, 1);border-top: 1px solid rgba(232, 232, 232, 1);margin-top: 30px;">' +
							'<div style="height: 60px;">' +
								'<div class="t-center" v-bind:class="list0Class" v-on:click="handleChangeTab(0)" style="width: 126px;border-right:1px solid rgba(232, 232, 232, 1);">Options</div>' +
								'<div class="t-center" v-bind:class="list1Class" v-on:click="handleChangeTab(1)" style="width: 126px;border-right:1px solid rgba(232, 232, 232, 1);">Images</div>' +
