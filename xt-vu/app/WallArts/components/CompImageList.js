...
module.exports = {
	...
	template:   '<div style="text-align: center;" v-on:click="blurFocus">' +
					'<div class="button" v-on:click="triggerImageUpload()" style="width: 324px;height: 32px;line-height: 32px;margin: 20px auto 0px;font-size: 14px;">Add Photos</div>' +
					'<div id="list-image" v-bind:style="{overflow: newImageList.length ? \'auto\': \'\' }">' +
						...
						'<div  v-show="!newImageList.length" v-on:click="triggerImageUpload()" class="item-empty">'+
	...
	events: {
		...
		notifyImageList: function() {
			...
			UtilWindow.initImageListSizeWithWallArts(this.privateStore.imageListParams);
