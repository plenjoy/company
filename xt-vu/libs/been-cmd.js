...
module.exports = {
  msgTempParas: {},			// 用于消息框功能传递参数对象保存

  datePicker: {},				// 用于保存当前日期选择框选择的日期,位置left, top
  timePicker: {},				// 用于保存当前时间选择框选择的时间

  chkboxSave: [],				// 用于保存用户checkbox传入保存的内容，数组索引对应bclass值

  timeCtrlFastmsg: [],	// 用于控制fastmsg的时间控制,包含5个数组对象，分别对应中间，左上，右上，左下，右下
  timeCtrlTimePicker: '',		// 用于时间选择框时间控制
  ...
  rebind: function() {
  	...
  	$('.been-manifest').off('click').click(function() {
  		...
  		if(sId !='' && sClass != '') {
  			...
  			_this.toggleManifest(sClass, sId, sCallback, sVal, sVar);
  		}
  		else {
  	...
  	$('.been-timepicker').off('click').click(function() {
  		...
  		_this.showTimePicker(tid, null, setLeft, setTop, bFixed, 'short');
  	});
  	...
  	$('.been-timepicker-long').off('click').click(function() {
  		...
  		_this.showTimePicker(tid, null, setLeft, setTop, bFixed, 'long');
  	});
  	...
  	$('.been-datepicker').off('click').click(function() {
  		...
  		if(bFixed=='true') {
  			...
  			_this.datePicker.bfixed = false;
  		};

  		_this.datePicker.setLeft = setLeft;
  		_this.datePicker.setTop = setTop;

  		_this.showDatePicker(tid, lang, null, sSeparator, nSequence);
  	});
  	...
  	$('.been-tip').off('focus').focus(function() {
  		...
  		if(sTip!='') {
  			_this.showFollowTip(sTip, cFont, cBg, setLeft, setTop, nSize, bFixed);
  		}
  		else {
  			// btip not found
  	...
  	$('.been-tip-lg').off('focus').focus(function() {
  		...
  		if(sTip!='') {
  			_this.showFollowTip(sTip, cFont, cBg, setLeft, setTop, nSize);
  		}
  		else {
  			// btip not found
    	...
    	if(sClass!='') {
    		if($(this).prop('checked') == true) {
    			...
    			for(i=0;i<clds.length;i++) {
    				...
    				if(sVal!='') {
  	  				_this.saveToChkbox(sClass, sVal);
  	  			}
  	  			else if(sVar!='') {
  	  				var theVar = clds.eq(i).attr(sVar) || '';
  	  				_this.saveToChkbox(sClass, theVar);
  	  			};
    ...
    $('.been-chkbox').off('click').click(function(event) {
    	...
    	if(sClass!='') {
    		if($(this).prop('checked') == true) {
    			...
    			// uncheck
    			if(sVal!='') {
    				_this.removeFromChkbox(sClass, sVal);
    			}
    			else if(sVar!='') {
    				sVal = $(this).attr(sVar) || '';
    				_this.removeFromChkbox(sClass, sVal);
    ...
    $('.been-toggle').off('click').click(function() {
    	...
    	if(sId!='') {
    		// toggleShow by id
    		_this.toggleShow('#'+sId, 'slide', sSpeed);
    	}
    	else if(sClass!='') {
    		// toggleShow by class
    		_this.toggleShow('.'+sClass, 'slide', sSpeed);
    	}
    	else {
    ...
    // 	if(sId!='') {
    // 		// toggleShow by id
    // 		_this.toggleShow('#'+sId, 'slide', sSpeed, 0, 1);
    // 	}
    // 	else if(sClass!='') {
    // 		// toggleShow by class
    // 		_this.toggleShow('.'+sClass, 'slide', sSpeed, 0, 1);
    // 	};
    // });
    ...
    $('.been-toggle-show').off('click').click(function() {
    	...
    	if(sId!='') {
    		// toggleShow by id
    		_this.toggleShow('#'+sId, 'show');
    	}
    	else if(sClass!='') {
    		// toggleShow by class
    		_this.toggleShow('.'+sClass, 'show');
    	}
    	else {
    		// neither bid nor bclass set
    ...
    $('.been-toggle-fade').off('click').click(function() {
    	...
    	if(sId!='') {
    		// toggleShow by id
    		_this.toggleShow('#'+sId, 'fade', sSpeed);
    	}
    	else if(sClass!='') {
    		// toggleShow by class
    		_this.toggleShow('.'+sClass, 'fade', sSpeed);
    	}
    	else {
    		// neither bid nor bclass set
    ...
    $('.been-toggle-slidein').off('click').click(function() {
    	...
    	if(sId!='') {
    		// toggleShow by id
    		_this.toggleShow('#'+sId, 'slide', sSpeed, 1);
    	}
    	else if(sClass!='') {
    		// toggleShow by class
    		_this.toggleShow('.'+sClass, 'slide', sSpeed, 1);
    	}
    	else {
    		// neither bid nor bclass set
    ...
    $('.been-toggle-showin').off('click').click(function() {
    	...
    	if(sId!='') {
    		// toggleShow by id
    		_this.toggleShow('#'+sId, 'show', null, 1);
    	}
    	else if(sClass!='') {
    		// toggleShow by class
    		_this.toggleShow('.'+sClass, 'show', null, 1);
    	}
    	else {
    		// neither bid nor bclass set
    ...
    $('.been-toggle-fadein').off('click').click(function() {
    	...
    	if(sId!='') {
    		// toggleShow by id
    		_this.toggleShow('#'+sId, 'fade', sSpeed, 1);
    	}
    	else if(sClass!='') {
    		// toggleShow by class
    		_this.toggleShow('.'+sClass, 'fade', sSpeed, 1);
    	}
    	else {
    		// neither bid nor bclass set
    ...
    $('.been-toggle-slideout').off('click').click(function() {
    	...
    	if(sId!='') {
    		// toggleShow by id
    		_this.toggleShow('#'+sId, 'slide', sSpeed, 2);
    	}
    	else if(sClass!='') {
    		// toggleShow by class
    		_this.toggleShow('.'+sClass, 'slide', sSpeed, 2);
    	}
    	else {
    		// neither bid nor bclass set
    ...
    $('.been-toggle-showout').off('click').click(function() {
    	...
    	if(sId!='') {
    		// toggleShow by id
    		_this.toggleShow('#'+sId, 'show', null, 2);
    	}
    	else if(sClass!='') {
    		// toggleShow by class
    		_this.toggleShow('.'+sClass, 'show', null, 2);
    	}
    	else {
    		// neither bid nor bclass set
    ...
    $('.been-toggle-fadeout').off('click').click(function() {
    	...
    	if(sId!='') {
    		// toggleShow by id
    		_this.toggleShow('#'+sId, 'fade', sSpeed, 2);
    	}
    	else if(sClass!='') {
    		// toggleShow by class
    		_this.toggleShow('.'+sClass, 'fade', sSpeed, 2);
    	}
    	else {
    		// neither bid nor bclass set
  ...
  // ***** show follow tip *****
  showFollowTip: function(sTipBody, cFont, cBg, nLeft, nTop, nSize, bFixed) {
  	// init 
  	...
  	if($('div#been-tip-box').length == 0) {
  		this.newFollowTip(boxSize, cFont, cBg);
  	};
  ...
  // ***** new follow tip *****
  newFollowTip: function(boxSize, cFont, cBg) {
  	var theTip = '';
  	// set tip box style
  ...
  // ***** show message *****
  // showMsg: function(sContent, sMsgType, sTitle, oParas, sYescall, sYestitle, sNocall, sNotitle) {
  // 	if(sContent) {
  // 		// init
  // 		var msgCont = {};
  ...
  // ***** show fast message *****
  showFastMsg: function(sFastMsg, sMsgType, sPos, sTimeOn) {
  	var _this = this;
    ...
    if(sFastMsg) {
  	  ...
  	  switch(sPos) {
  	  	case 'top':  // top center
  			  ...
  			  if(_this.timeCtrlFastmsg[0]) {
  			    clearTimeout(_this.timeCtrlFastmsg[0]);
  			  };
  			  _this.timeCtrlFastmsg[0] = setTimeout("$('#been-fastmsg-top').fadeOut(500);", sTimeOn);
  	  	  break;
  	  	case 'tl':  // top left
  	  	  $('#been-fastmsg-tl').text(sFastMsg);
  	  		$('#been-fastmsg-tl').css('left', 0);

  			  if(_this.timeCtrlFastmsg[1]) {
  			    clearTimeout(_this.timeCtrlFastmsg[1]);
  			  };
  			  _this.timeCtrlFastmsg[1] = setTimeout("$('#been-fastmsg-tl').css('left', '-455px');", sTimeOn);
  	  	  break;
  	  	case 'tr':  // top right
  	  		$('#been-fastmsg-tr').text(sFastMsg);
  	  		$('#been-fastmsg-tr').css('right', 0);

  			  if(_this.timeCtrlFastmsg[2]) {
  			    clearTimeout(_this.timeCtrlFastmsg[2]);
  			  };
  			  _this.timeCtrlFastmsg[2] = setTimeout("$('#been-fastmsg-tr').css('right', '-455px');", sTimeOn);
  	  	  break;
  	  	case 'bl':  // bottom left
  	  		$('#been-fastmsg-bl').text(sFastMsg);
  	  		$('#been-fastmsg-bl').css('left', 0);

  			  if(_this.timeCtrlFastmsg[3]) {
  			    clearTimeout(_this.timeCtrlFastmsg[3]);
  			  };
  			  _this.timeCtrlFastmsg[3] = setTimeout("$('#been-fastmsg-bl').css('left', '-455px');", sTimeOn);
  	  	  break;
  	  	case 'br':  // bottom right
  	  		$('#been-fastmsg-br').text(sFastMsg);
  	  		$('#been-fastmsg-br').css('right', 0);

  			  if(_this.timeCtrlFastmsg[4]) {
  			    clearTimeout(_this.timeCtrlFastmsg[4]);
  			  };
  			  _this.timeCtrlFastmsg[4] = setTimeout("$('#been-fastmsg-br').css('right', '-455px');", sTimeOn);
  	  	  break;
  	  	default: 
  ...
  // ***** hide fast message *****
  hideFastMsg: function(sPos) {
    // call it when you really need it!!
    sPos?sPos:sPos='top';
    
    switch(sPos) {
    	case 'tl':  // top left
    		if(this.timeCtrlFastmsg[1]) {
  			  clearTimeout(this.timeCtrlFastmsg[1]);
  			};
    		this.timeCtrlFastmsg[1] = setTimeout("$('#been-fastmsg-tl').css('left', '-455px');", 0);
    	  break;
    	case 'tr':  // top right
    		if(this.timeCtrlFastmsg[2]) {
  			  clearTimeout(this.timeCtrlFastmsg[2]);
  			};
    		this.timeCtrlFastmsg[2] = setTimeout("$('#been-fastmsg-tr').css('right', '-455px');", 0);
    	  break;
    	case 'bl':  // bottom left
    		if(this.timeCtrlFastmsg[3]) {
  			  clearTimeout(this.timeCtrlFastmsg[3]);
  			};
    		this.timeCtrlFastmsg[3] = setTimeout("$('#been-fastmsg-bl').css('left', '-455px');", 0);
    	  break;
    	case 'br':  // bottom right
    		if(this.timeCtrlFastmsg[4]) {
  			  clearTimeout(this.timeCtrlFastmsg[4]);
  			};
    		this.timeCtrlFastmsg[4] = setTimeout("$('#been-fastmsg-br').css('right', '-455px');", 0);
    	  break;
    	case 'top':  // top
    	default: // default as top
    		if(this.timeCtrlFastmsg[0]) {
  			  clearTimeout(this.timeCtrlFastmsg[0]);
  			};
  			this.timeCtrlFastmsg[0] = setTimeout("$('#been-fastmsg-top').fadeOut(500);", 0);
    };
  },
  // =========================== enf of 快速展示消息 ==========================
  ...
  // ***** save to checkbox *****
  saveToChkbox: function(sClass, sVal, sVar) {
    if(sClass && sVal) {
    	sClass = sClass.split('-')[0];
    	//if not exists, create the target array
    	if(!this.chkboxSave[sClass]) {
    		this.chkboxSave[sClass] = [];
    	};

      if(this.inArray(sVal, this.chkboxSave[sClass])==-1) {
        //不存在数组中，po进
        this.chkboxSave[sClass].push(sVal);
      };
    };
  },

  // ***** remove from checkbox *****
  removeFromChkbox: function(sClass, sVal, sVar) {
  	if(sClass && sVal) {
    	sClass = sClass.split('-')[0];
    	//if not exists, create the target array
    	if(!this.chkboxSave[sClass]) {
      ...
      if(this.inArray(sVal, this.chkboxSave[sClass])!=-1) {
        //存在数组中，remove掉
        this.removeFromArray(sVal, this.chkboxSave[sClass]);
      };
    };
  },

  // ***** query checkbox save *****
  getChkboxSave: function(sClass) {
  	if(sClass) {
  		// query specific bclass array
  		if(this.chkboxSave && this.chkboxSave[sClass]) {
  			return this.chkboxSave[sClass];
  		}
  		else {
  			return [];
  		};
  ...
  // ***** toggle show *****
  toggleShow: function(sTar, sType, sSpeed, nLimit, nDirect) {
  	...
  	if(sTar && (sTar[0]=='#' || sTar[0]=='.')) {
  		...
  		var theTargets = [];
  		var cat = sTar[0];	// '#' or '.'
  		var newTar = this.trimAll(sTar);		// trim all blank spaces
  ...
  isEmail: function(sEmail, sDomain) {
    if(sEmail) {
    	// valid email
    	if(sDomain) {
  ...
  // ***** is in domain *****
  isInDomain: function(sDomain, sUrl) {
    if(sDomain && sUrl && sDomain != '' && sUrl != '' && this.isDomain(sDomain)) {
    	// valid parameters passed in
    	var urlDomain = this.getDomain(sUrl);
  ...
  isMac: function(sMac, sSeparator) {
    if(sMac && sMac != '') {
    	// MAC passed in
  ...
  // ***** remove from array *****
  removeFromArray: function(tar, arr) {
  	if(tar && arr) {
  		var tarIndex = this.inArray(tar, arr);
  	  if(tarIndex!=-1) {
  ...
  // ***** date picker *****
  // showDatePicker: function(tid, lang, nowTime, sSeparator, nSequence) {
  // 	if(tid) {
  // 		// init now time
  // 		if(nowTime) {
  ...
  // 		}
  // 		else if(this.datePicker.pickedDate && this.datePicker.pickedDate != '') {
  // 			// found previous picked date
  // 			nowTime = new Date(this.datePicker.pickedDate);
  // 		}
  // 		else {
  // 			nowTime = new Date();
  // 		};
  ...
  // // ***** choose year *****
  // datePickerChooseYear: function(tid, lang, nowTime, sep, nSequence) {
  // 	var tidStr = "'" + tid + "'";
  // 	var langStr = "'" + lang + "'";
  // 	var sepStr = "'" + sep + "'";
  // 	nowTime = new Date(nowTime);
  ...
  // // ***** choose month *****
  // datePickerChooseMonth: function(tid, lang, nowTime, sep, nSequence) {
  // 	var tidStr = "'" + tid + "'";
  // 	var langStr = "'" + lang + "'";
  // 	var sepStr = "'" + sep + "'";
  // 	nowTime = new Date(nowTime);
  ...
  // datePickerSet: function(tid, dateVal) {
  ...
  // // ***** show time picker *****
  // showTimePicker: function(tid, nowTime, setLeft, setTop, bFixed, sType, sTimeFix) {
  ...
  // unbindTimePickerEvent: function() { 
  ...
  // timePickerSet: function(tid, timeVal) {
  ...
  // ***** toggle manifest *****
  toggleManifest: function(sClass, sId, sCallback, sVal, sVar) {
  	// init
  	sClass = sClass || '';
  	sId = sId || '';
  	sCallback = sCallback || '';
