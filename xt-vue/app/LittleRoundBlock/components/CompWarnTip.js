...
module.exports = {
    template: '<div id="warnTipElement-{{pagedd}}{{ id }}{{main}}" v-show="scale > warnTipLimit" v-bind:style="{ height:  (privateStore.height) + \'px\', bottom: bottom + \'px\', left: left + \'px\', zIndex: windowZindex }" style="position: absolute;cursor:pointer;">' +
    ...
    computed: {
        ...
        left : function(){
            ...
            switch(this.sharedStore.projectSettings[this.pagedd]['product']) {
                ...
                case 'LSC':
                case 'mountPrint': {
                    return this.x - this.privateStore.width / 2;
