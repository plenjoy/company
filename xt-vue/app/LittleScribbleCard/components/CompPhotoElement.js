module.exports = {
    ...
    template: '<div style="position:absolute; box-sizing: border-box;" @click="changePageIdx" v-bind:style="usedStyle">' +
                    ...
                    '<handle v-if="!sharedStore.isPreview && extraName"  v-bind:pagedd="pageIdx" v-bind:id="id" v-bind:main="extraName" v-bind:is-Show-Handles="isShowHandle" v-bind:is-Corner-Handles="false" v-bind:is-Side-Handles="false"></handle>'+
    ...
    methods: {
            ...
            require("DrawManage").drawImage("photoElementCanvas"+this.pageIdx+this.id+this.extraName, url, 0, 0,function(){
                // if(_this.sharedStore.projectSettings[Store.currentSelectProjectIndex].product==="canvas"){
                    ...
                    if(_this.extraName) {
                        ...
                        setTimeout(function(){
                            Store.vm.$broadcast("notifyRefreshRealScreenshot", _this.pageIdx, _this.ratio);
                        },100);
                    }
                // }
        ...
        setImageById:function(imageId){
            ...
            Store.dropData.isBg=false;
            Store.dropData.newAdded=false;
            Store.dragData.imageId=imageId.toString();
    ...
    events: {
        ...
        dispatchClick:function(oParams){
            ...
            if(this.isShowUploadButton){
                ...
                this.sharedStore.watchData.replacePageId = this.pageIdx;
