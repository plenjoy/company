...
module.exports = {
  ...
  computed: {
    ...
    boxLeft: function() {
      ...
      }else if(-currentCanvas.x + currentCanvas.bgWidth - 130 < this.sharedStore.barPosition.x){
    ...
    boxTop: function() {
      ...
      } else if(currentCanvas.height - 80 < this.sharedStore.barPosition.y){
        return this.sharedStore.barPosition.y - 80;

      }else if(-currentCanvas.y + currentCanvas.bgHeight - 80 < this.sharedStore.barPosition.y){
        return this.sharedStore.barPosition.y - 80;
